    ...
    public  void refusMission ()  {
        ...
        pt.setOnFinished(ev -> {
            ...
            if (userIdTxt.getText().trim().equals("") || statutTxt1.getText().trim().equals("") || idMissionTxt.getText().trim().equals("")) {
                ...
                try {
                    CandidatDao.refuseMission(Integer.parseInt(userIdTxt.getText()), Integer.parseInt(statutTxt1.getText()), Integer.parseInt(idMissionTxt.getText()));
                ...
                NotifyMe notifyMe = new NotifyMe();
                notifyMe.showPopupNotificationWhenSoldeIsCredi();
                progress.setVisible(false);
            }
        });
        pt.play();
